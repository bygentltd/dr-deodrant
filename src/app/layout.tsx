...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={cn("light", "font-serif", geist.variable)}>
      <head>
      ...
      <body className="bg-surface text-on-background font-serif selection:bg-clinical-blue selection:text-white">
        <LenisProvider>
            ...
            <footer className="bg-deep-navy dark:bg-on-background w-full mt-margin-desktop">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-desktop py-20 w-full max-w-container-max mx-auto">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Shop All</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Best Sellers</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Ingredients</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Subscriptions</Link>
                </div>
                <div className="flex flex-col gap-4">
                  <h5 className="text-ice-glimmer font-bold uppercase tracking-widest text-sm mb-4">About</h5>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Sustainability</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Our Story</Link>
                  <Link className="text-ice-glimmer font-bold transition-all duration-300 hover:-translate-y-1" href="/blog">Journal</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Contact</Link>
                </div>
                <div className="flex flex-col gap-4">
                  <h5 className="text-ice-glimmer font-bold uppercase tracking-widest text-sm mb-4">Support</h5>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Shipping</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Returns</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Privacy</Link>
                  <Link className="text-secondary-fixed-dim hover:text-tertiary-fixed transition-all duration-300 hover:-translate-y-1" href="/">Terms</Link>
                </div>
              </div>
