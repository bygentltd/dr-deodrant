export default function TheBeginning() {
  return (
    <section className="bg-[#F5FBFF] px-4 sm:px-6 py-16 md:py-28 md:px-16 lg:px-32 font-sans w-full">
      <div className="max-w-7xl mx-auto w-full">
        {/* Main Heading */}
        <h1 className="text-4xl sm:text-5xl md:text-[3rem] lg:text-[4rem] font-medium text-[#003286] mb-10 md:mb-16 tracking-tight">
          The Beginning
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="md:col-span-8 lg:col-span-8 flex flex-col gap-6 md:gap-10">
            {/* Primary Paragraph */}
            <p className="font-inter text-[15px] sm:text-base leading-relaxed md:leading-normal text-left sm:text-justify text-[#4a4a4a] max-w-3xl">
            ...
            <p className="font-inter text-[15px] sm:text-base text-left sm:text-justify leading-relaxed md:leading-normal text-[#4a4a4a] max-w-3xl">
