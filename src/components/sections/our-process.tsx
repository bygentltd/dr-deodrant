export default function OurProcess() {
  ...
  return (
    <section className="bg-[#C6D9F1] px-6 py-24 md:py-32 md:px-16 lg:px-32 font-sans w-full">
      <div className="max-w-7xl mx-auto w-full">
        {/* Main Heading */}
        <div className="max-w-3xl mb-10 md:mb-14 process-reveal">
          <div className="inline-flex items-center rounded-full bg-[#203956] px-4 py-1.5 text-sm font-medium text-[#ffffff] tracking-wide mb-5">
            Our Process
          </div>
          <h1 className="text-6xl md:text-[3rem] lg:text-[4rem] font-medium text-[#203956] tracking-tight">
          Our Process
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 mb-24 md:mb-32 process-reveal process-reveal-delay-1">
          ...
          <div className="md:col-span-4 lg:col-span-4 flex md:justify-end items-start">
            <div className="process-orbit relative w-full max-w-xs rounded-[2rem] border border-white/50 bg-white/40 backdrop-blur-sm p-5 shadow-[0_20px_50px_rgba(32,57,86,0.08)]">
              ...
              <p className="relative text-sm md:text-base leading-relaxed text-[#203956] font-medium">
          ...
          {principles.map((principle, idx) => (
            <div key={principle.number} className="process-card flex flex-col">
              <div className="mb-6 relative">
                <div className="process-number-badge absolute -top-4 left-4 z-10 inline-flex items-center justify-center rounded-full bg-[#203956] px-4 py-1.5 text-sm font-medium text-white shadow-lg">
