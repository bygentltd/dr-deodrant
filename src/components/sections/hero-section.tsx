  ...
  return (
    <section className="relative min-h-screen h-[calc(100svh+4rem)] md:h-[calc(100svh+7rem)] w-full overflow-hidden" id="hero-section">
      ...
      <div className={`relative z-10 h-full flex flex-col items-start justify-center text-left px-6 ${heroContentOffset}`}>
        <div className="mb-4">
          <span className="block font-cabinet text-sm uppercase tracking-[0.3em] text-[#0a2544] drop-shadow-md">CERTIFIED · TESTED · SKIN-FRIENDLY</span>
        </div>
        <div className="mb-8">
          <h1 className="max-w-4xl text-6xl font-cabinet font-bold leading-[1.1] text-[#0a2544] drop-shadow-xl md:text-7xl">Skincare For <br/>Your Underarms</h1>
        </div>
