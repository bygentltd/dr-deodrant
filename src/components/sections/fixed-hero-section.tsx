  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 max-w-4xl mx-auto reveal-on-scroll">
        ...
        {/* Top Eyebrow Text */}
        <span className="text-[6px] sm:text-xs font-bold text-[#F5FBFF] uppercase tracking-[0.2em] mb-3 sm:mb-4">
          PURE & NATURAL PROTECTION
        </span>

        {/* Main Heading */}
        <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-inter font-bold text-[#F5FBFF] mb-4 sm:mb-6 leading-tight">
          Stay Odor-Free. <br /> Stay Unstoppable.
        </h2>

        {/* Subtitle */}
        <p className="text-[10px] sm:text-xs md:text-sm font-light font-inter text-[#F5FBFF]/90 mb-8 sm:mb-10 max-w-[280px] sm:max-w-xl md:max-w-2xl leading-relaxed">
