  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 max-w-4xl mx-auto reveal-on-scroll">
        ...
        {/* Top Eyebrow Text */}
        <span className="text-[10px] sm:text-xs md:text-sm font-bold text-[#F5FBFF] uppercase tracking-[0.2em] mb-3 sm:mb-4">
        ...
        {/* Subtitle */}
        <p className="text-sm sm:text-base md:text-lg font-light font-inter text-[#F5FBFF]/90 mb-8 sm:mb-10 max-w-[320px] sm:max-w-xl md:max-w-2xl leading-relaxed">
