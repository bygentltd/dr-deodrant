...
export default function MeetTheFounders() {
  ...
  return (
    <section className="bg-[#F5FBFF] px-4 py-12 md:px-8 lg:px-16 w-full font-sans">
      <div 
        ref={sectionRef}
        className="bg-[#EAF5FF] rounded-[2rem] md:rounded-[3rem] p-6 pt-16 md:p-16 lg:p-24 w-full max-w-[1400px] mx-auto"
      >
        {/* Top Header */}
