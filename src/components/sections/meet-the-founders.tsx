...
export default function MeetTheFounder() {
  ...
  return (
    <section className="bg-[#F5FBFF] px-4 py-10 md:px-8 w-full font-sans">
      ...
      >
        {/* Top Header */}
        <div className="mb-10 md:mb-12 md:text-center lg:text-left">
          {/* Scaled down from 5xl/7xl to 4xl/6xl */}
          <h2 className="text-2xl md:text-3xl lg:text-5xl font-medium tracking-tight text-[#313131] max-w-2xl lg:max-w-none">
            Meet the Founder
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="relative w-full aspect-[4/5] md:aspect-[3/4] lg:aspect-[4/5] overflow-hidden rounded-xl group">
            ...
            <div className="absolute bottom-5 left-5 md:bottom-6 md:left-6 text-white/95">
              <p className="text-[9px] md:text-[10px] font-medium tracking-wider mb-1 uppercase opacity-90">
                Founder & Formulator
              </p>
          ...
          <div className="flex flex-col gap-8 lg:gap-10">
            <div>
              <span className="text-xs md:text-sm font-medium text-[#4a4a4a] tracking-wide mb-3 block">
                Singer. Songwriter. Visionary.
              </span>
              {/* Scaled down from 4xl/42px to 3xl/4xl */}
              <h3 className="text-lg md:text-xl lg:text-2xl leading-[1.2] font-medium text-[#313131]">
